...
import com.google.android.gms.oss.licenses.OssLicensesMenuActivity // Para licenças
    ...
    fun initPopupMenu(anchor: View, @MenuRes menu: Int = 0, onClick: (MenuItem) -> Boolean = { false }, onUpdate: Menu.() -> Unit = {}): PopupMenu {
        ...
        popupMenu.setOnMenuItemClickListener {
            when (it?.itemId) {
                ...
                R.id.menu_item_oss -> startActivity(Intent(this, OssLicensesMenuActivity::class.java))
